...
$('.navbar-scroll-to a, a.scroll-arrow , a.navbar-brand').click(function(e){
    e.preventDefault();
...
rubik = {
    ...
    initRightMenu: function(){  
         if(!navbar_initialized){
             ...
             $navbar.addClass('navbar-scroll-to');
             $('body').append($navbar);
    ...
    checkResponsiveImage: function(){
        $('.section-header img, .section-header video').each(function(){
            var $image = $(this);
